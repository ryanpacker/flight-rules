 ...
 */
function parseIntArg(args: string[], longFlag: string, shortFlag: string, defaultValue: number): number {
 ...
 */
function parseStringArg(args: string[], longFlag: string): string | undefined {
  // Check for --flag value format
  const longIndex = args.findIndex(arg => arg === longFlag);
 ...
 */
function parseBranchArg(args: string[]): string | boolean | undefined {
